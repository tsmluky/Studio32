...
- Root `index.html` redirects to `Agencia-Portfolio/`.
...
```
ejemplos landing/
├── index.html                     ← redirect to Agencia-Portfolio/
├── CLAUDE.md                      ← this file
...
├── Landing1-LOscur/             ← Premium restaurant demo
│   ├── index.html
...
- L'Obscur: entry is `index.html (normalizado — antes era restaurant_landing.html).
